...
"""
import unittest
class TestHolidayFunctions(unittest.TestCase):
    def test_python2(self):
        if sys.version_info >= (3, 0, 0):
            return
        # 祝日以外
        self.assertIsNone(holiday_name(2007, 4, 28))
        # 昭和の日
        self.assertEqual(holiday_name(2007, 4, 29), u'\u662d\u548c\u306e\u65e5')

        # DateTime.date での判定
        date = datetime.date(2007, 4, 29)
        self.assertEqual(holiday_name(date = date), u'\u662d\u548c\u306e\u65e5')
    ...
    def test_python3(self):
        ...
        self.assertIsNone(holiday_name(2007, 4, 28))
        # 昭和の日
        self.assertEqual(holiday_name(2007, 4, 29), '昭和の日')

        # DateTime.date での判定
        date = datetime.date(2007, 4, 29)
        self.assertEqual(holiday_name(date = date), '昭和の日')
